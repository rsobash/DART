...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/observations/radar/create_obs_radar_sequence.f90 $
! $Id: create_obs_radar_sequence.f90 4933 2011-06-01 17:55:44Z thoar $
! $Revision: 4933 $
...
character(len=128), parameter :: &
   source = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/observations/radar/create_obs_radar_sequence.f90 $"
character(len=128), parameter :: revision = "$Revision: 4933 $"
character(len=128), parameter :: & 
