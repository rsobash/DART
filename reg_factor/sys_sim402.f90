...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/reg_factor/sys_sim402.f90 $
! $Id: sys_sim402.f90 4933 2011-06-01 17:55:44Z thoar $
! $Revision: 4933 $
...
character(len=128), parameter :: &
   source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/reg_factor/sys_sim402.f90 $", &
