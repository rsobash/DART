...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/filter/filter.f90 $
! $Id: filter.f90 4959 2011-06-08 14:55:02Z nancy $
! $Revision: 4959 $
...
character(len=128), parameter :: &
   source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/filter/filter.f90 $", &
