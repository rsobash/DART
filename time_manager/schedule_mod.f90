...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/time_manager/schedule_mod.f90 $
! $Id: schedule_mod.f90 4947 2011-06-02 23:20:44Z thoar $
! $Revision: 4947 $
...
character(len=128), parameter :: &
   source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/time_manager/schedule_mod.f90 $", &
