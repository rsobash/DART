...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/time_manager/time_manager_mod.f90 $
! $Id: time_manager_mod.f90 4918 2011-05-25 22:57:43Z thoar $
! $Revision: 4918 $
...
character(len=128), parameter :: &
   source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/time_manager/time_manager_mod.f90 $", &
