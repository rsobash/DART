...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/time_manager/advance_time.f90 $
! $Id: advance_time.f90 4933 2011-06-01 17:55:44Z thoar $
! $Revision: 4933 $
...
character(len=128), parameter :: &
   source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/time_manager/advance_time.f90 $", &
