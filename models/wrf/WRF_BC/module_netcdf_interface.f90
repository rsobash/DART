...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/models/wrf/WRF_BC/module_netcdf_interface.f90 $
! $Id: module_netcdf_interface.f90 5589 2012-03-06 21:49:56Z nancy $
! $Revision: 5589 $
! $Date: 2012-03-06 15:49:56 -0600 (Tue, 06 Mar 2012) $
...
character(len=128), parameter :: &
   source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/models/wrf/WRF_BC/module_netcdf_interface.f90 $", &
   revision = "$Revision: 5589 $", &
   revdate  = "$Date: 2012-03-06 15:49:56 -0600 (Tue, 06 Mar 2012) $"
