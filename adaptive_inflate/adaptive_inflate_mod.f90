...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/adaptive_inflate/adaptive_inflate_mod.f90 $ 
! $Id: adaptive_inflate_mod.f90 5809 2012-07-20 23:00:49Z thoar $ 
! $Revision: 5809 $ 
! $Date: 2012-07-20 18:00:49 -0500 (Fri, 20 Jul 2012) $ 
!
...
character(len=128), parameter :: &
   source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/adaptive_inflate/adaptive_inflate_mod.f90 $", &
   revision = "$Revision: 5809 $", &
   revdate  = "$Date: 2012-07-20 18:00:49 -0500 (Fri, 20 Jul 2012) $"
