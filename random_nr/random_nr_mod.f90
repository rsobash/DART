...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/random_nr/random_nr_mod.f90 $
! $Id: random_nr_mod.f90 5048 2011-06-30 20:40:19Z thoar $
! $Revision: 5048 $
! $Date: 2011-06-30 15:40:19 -0500 (Thu, 30 Jun 2011) $
...
character(len=128), parameter :: &
   source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/random_nr/random_nr_mod.f90 $", &
   revision = "$Revision: 5048 $", &
   revdate  = "$Date: 2011-06-30 15:40:19 -0500 (Thu, 30 Jun 2011) $"
