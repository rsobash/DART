...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/obs_sequence/obs_sequence_tool.f90 $
! $Id: obs_sequence_tool.f90 5592 2012-03-06 23:59:09Z nancy $
! $Revision: 5592 $
! $Date: 2012-03-06 17:59:09 -0600 (Tue, 06 Mar 2012) $
...
character(len=128), parameter :: &
   source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/obs_sequence/obs_sequence_tool.f90 $", &
   revision = "$Revision: 5592 $", &
   revdate  = "$Date: 2012-03-06 17:59:09 -0600 (Tue, 06 Mar 2012) $"
