...
character(len=128), parameter :: &
   source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/obs_sequence/obs_common_subset.f90 $", &
...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/obs_sequence/obs_common_subset.f90 $
! $Id: obs_common_subset.f90 4918 2011-05-25 22:57:43Z thoar $
! $Revision: 4918 $
