...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/common/types_mod.f90 $
! $Id: types_mod.f90 5817 2012-07-24 16:01:04Z nancy $
! $Revision: 5817 $
! $Date: 2012-07-24 11:01:04 -0500 (Tue, 24 Jul 2012) $
...
character(len=128), parameter :: &
   source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/common/types_mod.f90 $", &
   revision = "$Revision: 5817 $", &
   revdate  = "$Date: 2012-07-24 11:01:04 -0500 (Tue, 24 Jul 2012) $"
