...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/ensemble_manager/ensemble_manager_mod.f90 $
! $Id: ensemble_manager_mod.f90 5811 2012-07-23 20:13:20Z nancy $
! $Revision: 5811 $
! $Date: 2012-07-23 15:13:20 -0500 (Mon, 23 Jul 2012) $
...
character(len=128), parameter :: &
   source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/ensemble_manager/ensemble_manager_mod.f90 $", &
   revision = "$Revision: 5811 $", &
   revdate  = "$Date: 2012-07-23 15:13:20 -0500 (Mon, 23 Jul 2012) $"
