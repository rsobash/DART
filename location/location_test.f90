...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/location/location_test.f90 $
! $Id: location_test.f90 5329 2011-10-07 19:24:51Z nancy $
! $Revision: 5329 $
! $Date: 2011-10-07 14:24:51 -0500 (Fri, 07 Oct 2011) $
...
character(len=128), parameter :: &
   source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/location/location_test.f90 $", &
   revision = "$Revision: 5329 $", &
   revdate  = "$Date: 2011-10-07 14:24:51 -0500 (Fri, 07 Oct 2011) $"
