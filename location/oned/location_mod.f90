...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/location/oned/location_mod.f90 $
...
character(len=128), parameter :: &
   source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/location/oned/location_mod.f90 $", &
