...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/location/threed_sphere/location_mod.f90 $
! $Id: location_mod.f90 5593 2012-03-07 21:08:42Z nancy $
! $Revision: 5593 $
! $Date: 2012-03-07 15:08:42 -0600 (Wed, 07 Mar 2012) $
...
character(len=128), parameter :: &
   source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/location/threed_sphere/location_mod.f90 $", &
   revision = "$Revision: 5593 $", &
   revdate  = "$Date: 2012-03-07 15:08:42 -0600 (Wed, 07 Mar 2012) $"
