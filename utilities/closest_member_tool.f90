...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/utilities/closest_member_tool.f90 $
! $Id: closest_member_tool.f90 5419 2011-11-28 23:28:01Z nancy $
! $Revision: 5419 $
! $Date: 2011-11-28 17:28:01 -0600 (Mon, 28 Nov 2011) $
...
character(len=128), parameter :: &
   source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/utilities/closest_member_tool.f90 $", &
   revision = "$Revision: 5419 $", &
   revdate  = "$Date: 2011-11-28 17:28:01 -0600 (Mon, 28 Nov 2011) $"
