...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/diagnostics/oned/obs_diag.f90 $
...
character(len=128), parameter :: &
   source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/diagnostics/oned/obs_diag.f90 $", &
