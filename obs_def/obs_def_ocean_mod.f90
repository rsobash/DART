...
!SEA_SURFACE_PRESSURE,          KIND_SEA_SURFACE_PRESSURE,  COMMON_CODE
...
!BOTTLE_SALINITY,               KIND_SALINITY,              COMMON_CODE
!BOTTLE_TEMPERATURE,            KIND_TEMPERATURE,           COMMON_CODE
!CTD_SALINITY,                  KIND_SALINITY,              COMMON_CODE
!CTD_TEMPERATURE,               KIND_TEMPERATURE,           COMMON_CODE
!TCTD_SALINITY,                 KIND_SALINITY,              COMMON_CODE
!TCTD_TEMPERATURE,              KIND_TEMPERATURE,           COMMON_CODE
!STD_SALINITY,                  KIND_SALINITY,              COMMON_CODE
!STD_TEMPERATURE,               KIND_TEMPERATURE,           COMMON_CODE
!XCTD_SALINITY,                 KIND_SALINITY,              COMMON_CODE
!XCTD_TEMPERATURE,              KIND_TEMPERATURE,           COMMON_CODE
!MBT_SALINITY,                  KIND_SALINITY,              COMMON_CODE
!MBT_TEMPERATURE,               KIND_TEMPERATURE,           COMMON_CODE
!XBT_SALINITY,                  KIND_SALINITY,              COMMON_CODE
!XBT_TEMPERATURE,               KIND_TEMPERATURE,           COMMON_CODE
!DBT_SALINITY,                  KIND_SALINITY,              COMMON_CODE
!DBT_TEMPERATURE,               KIND_TEMPERATURE,           COMMON_CODE
!APB_SALINITY,                  KIND_SALINITY,              COMMON_CODE
!APB_TEMPERATURE,               KIND_TEMPERATURE,           COMMON_CODE
...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/obs_def/obs_def_ocean_mod.f90 $
! $Id: obs_def_ocean_mod.f90 4933 2011-06-01 17:55:44Z thoar $
! $Revision: 4933 $
...
character(len=128), parameter :: &
   source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/obs_def/obs_def_ocean_mod.f90 $", &
