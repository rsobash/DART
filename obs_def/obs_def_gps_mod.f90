...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/obs_def/obs_def_gps_mod.f90 $
! $Id: obs_def_gps_mod.f90 4955 2011-06-07 22:11:08Z nancy $
! $Revision: 4955 $
! $Date: 2011-06-07 17:11:08 -0500 (Tue, 07 Jun 2011) $
...
character(len=128), parameter :: &
   source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/obs_def/obs_def_gps_mod.f90 $", &
   revision = "$Revision: 4955 $", &
   revdate  = "$Date: 2011-06-07 17:11:08 -0500 (Tue, 07 Jun 2011) $"
