...
! $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/obs_def/obs_def_upper_atm_mod.f90 $
! $Id: obs_def_upper_atm_mod.f90 4947 2011-06-02 23:20:44Z thoar $
! $Revision: 4947 $
...
character(len=128) :: &
source   = "$URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Kodiak/obs_def/obs_def_upper_atm_mod.f90 $", &
revision = "$Revision: 4947 $", &
revdate  = "$Date: 2011-06-02 18:20:44 -0500 (Thu, 02 Jun 2011) $"
